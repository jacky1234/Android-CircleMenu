...
public class CircleMenuLayout extends ViewGroup {
     ...
     * 菜单的中心child的默认尺寸
     */
    private float RADIO_DEFAULT_CENTERITEM_DIMENSION = 2 / 3f;
    /**
     * 该容器的内边距,无视padding属性，如需边距请用该变量
     */
    private static final float RADIO_PADDING_LAYOUT = 1 / 6f;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (cView != null) {
            ...
            // 设置center item位置
            int cl = mRadius - cView.getMeasuredWidth() / 2;
